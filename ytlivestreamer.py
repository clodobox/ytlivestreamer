...
def main():
    ...
    parser.add_argument("-f", "--future", action="store_true", help="Download current and future live streams")
    parser.add_argument("-a", "--all", action="store_true", help="Download all old and future live streams")
    parser.add_argument("-c", "--current-only", action="store_true", help="Download only the current live stream and stop")
    parser.add_argument("-e", "--encapsulation", choices=["mkv", "mp4"], default="mkv", help="Encapsulation format (default: mkv)")
    parser.add_argument("-q", "--quality", default="bestvideo+bestaudio/best", help="Video quality (default: best)")
    ...
    try:
        channel_id = get_channel_id(args.channel_url)
        if channel_id:
